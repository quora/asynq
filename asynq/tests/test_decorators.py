...
from asynq import coroutine, async_proxy, is_pure_async_fn, result, async_call, ConstFuture
...
class MyClass(object):
    ...
    @coroutine(sync_fn=sync_staticmethod)
    @staticmethod
    ...
    @coroutine(sync_fn=sync_classmethod)
    @classmethod
